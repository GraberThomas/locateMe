    ...
    return (
        <div className='bg-[#f1f1f1] grow mx-[5vw] my-[10vh] rounded-3xl relative shadow-contacts_shadow'>
            ...
            <div className="absolute flex justify-center items-center bottom-0 rounded-lg overflow-hidden h-[10%] w-full">
                <button className='h-10 w-40 bg-button text-center py-[10px] px-[15px] rounded-[12px] text-black font-bold transition-all hover:bg-button_hover hover:shadow-btn_shadow text-[#f3ffcf]'>Add a contact</button>
            </div>
        </div>
    );
};
